...
type FastOrderServiceClient interface {
	...
	LandingOrder(ctx context.Context, in *LandingOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *fastOrderServiceClient) LandingOrder(ctx context.Context, in *LandingOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/services.fastOrder_service.FastOrderService/LandingOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FastOrderServiceServer interface {
	...
	LandingOrder(context.Context, *LandingOrderRequest) (*emptypb.Empty, error)
...
func (UnimplementedFastOrderServiceServer) LandingOrder(context.Context, *LandingOrderRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LandingOrder not implemented")
}
...
func _FastOrderService_LandingOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LandingOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FastOrderServiceServer).LandingOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/services.fastOrder_service.FastOrderService/LandingOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FastOrderServiceServer).LandingOrder(ctx, req.(*LandingOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FastOrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "LandingOrder",
			Handler:    _FastOrderService_LandingOrder_Handler,
		},
	},
