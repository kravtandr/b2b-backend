...
var file_pkg_services_chat_api_proto_rawDesc = []byte{
	...
	0x01, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x32, 0x67, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x58, 0x0a, 0x09, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	0x55, 0x73, 0x65, 0x72, 0x12, 0x23, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	0x63, 0x68, 0x61, 0x74, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4c, 0x6f, 0x67,
	...
	0x00, 0x42, 0x26, 0x5a, 0x24, 0x62, 0x32, 0x62, 0x2f, 0x6d, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x3b, 0x63, 0x68, 0x61,
...
var file_pkg_services_chat_api_proto_goTypes = []interface{}{
	(*LoginRequest)(nil),             // 0: services.chat_service.LoginRequest
	(*RegisterResponse)(nil),         // 1: services.chat_service.RegisterResponse
	(*LoginResponse)(nil),            // 2: services.chat_service.LoginResponse
	(*RegisterRequest)(nil),          // 3: services.chat_service.RegisterRequest
	(*GetUserRequest)(nil),           // 4: services.chat_service.GetUserRequest
	(*FastRegisterRequest)(nil),      // 5: services.chat_service.FastRegisterRequest
	(*GetUserResponse)(nil),          // 6: services.chat_service.GetUserResponse
	(*UpdateUserRequest)(nil),        // 7: services.chat_service.UpdateUserRequest
	(*Session)(nil),                  // 8: services.chat_service.Session
	(*ValidateSessionResponse)(nil),  // 9: services.chat_service.ValidateSessionResponse
	(*UserInfo)(nil),                 // 10: services.chat_service.UserInfo
	(*UserEmailRequest)(nil),         // 11: services.chat_service.UserEmailRequest
	(*UserId)(nil),                   // 12: services.chat_service.UserId
	(*GetUserIdByCookieRequest)(nil), // 13: services.chat_service.GetUserIdByCookieRequest
	(*GetPublicUserResponse)(nil),    // 14: services.chat_service.GetPublicUserResponse
	(*CheckEmailRequest)(nil),        // 15: services.chat_service.CheckEmailRequest
}
var file_pkg_services_chat_api_proto_depIdxs = []int32{
	0, // 0: services.chat_service.ChatService.LoginUser:input_type -> services.chat_service.LoginRequest
	2, // 1: services.chat_service.ChatService.LoginUser:output_type -> services.chat_service.LoginResponse
