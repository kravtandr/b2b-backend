...
const (
	...
	createGetMsgById      = "SELECT id, chat_id, sender_id, receiver_id, checked, text, type, created_at FROM Msgs WHERE id = $1"
	...
	createUpdateMsg       = "UPDATE Msgs SET checked = $1, text = $2, type = $3 WHERE id = $4"
