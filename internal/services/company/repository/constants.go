...
const (
	...
	createUpdateCompanyUsersLink            = "UPDATE CompaniesUsers SET post = $3 WHERE company_id = $1 and user_id = $2 RETURNING id, company_id, user_id, post, itn"
	createGetCompanyUserLinkByOwnerIdAndItn = "SELECT  id, company_id, user_id, post, itn FROM CompaniesUsers WHERE user_id = $1 and itn = $2"
)
